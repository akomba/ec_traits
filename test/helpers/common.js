...
class Data {
  ...
  async init() {
    [this.deployerSigner, 
      this.user1Signer, this.user2Signer, this.user3Signer, this.user4Signer, this.user5Signer, this.user6Signer, this.user7Signer, this.user8Signer ] = await ethers.getSigners();
    [this.deployer, 
      this.user1, this.user2, this.user3, this.user4, this.user5, this.user6, this.user7, this.user8 ] = await Promise.all([this.deployerSigner.getAddress(), this.user1Signer.getAddress(), this.user2Signer.getAddress(), this.user3Signer.getAddress(), this.user4Signer.getAddress(), this.user5Signer.getAddress(), this.user6Signer.getAddress(), this.user7Signer.getAddress(), this.user8Signer.getAddress() ]);
